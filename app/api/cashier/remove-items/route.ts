  ...
  try {
    ...
    try {
      for (const item of body.items) {
        ...
        const currentRow: OrderItemRow | undefined = Array.isArray(currentResult)
          ? (currentResult[0] as OrderItemRow | undefined)
          : (currentResult as QueryRowsResult<OrderItemRow>)?.rows?.[0];
